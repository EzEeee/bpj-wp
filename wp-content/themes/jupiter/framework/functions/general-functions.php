...
/* 
 * To remove special characters from uploaded files
 */
function mk_sanitize_filename_on_upload($filename) {
...
add_filter('sanitize_file_name', 'mk_sanitize_filename_on_upload', 10);
