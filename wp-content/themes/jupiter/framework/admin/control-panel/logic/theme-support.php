<div class="control-panel-holder">
	...
	<div class="support-page cp-pane">
			...
			<div class="cp-support">
				...
				<p>Read helpful resources regarding how to use Jupiter more efficiantly.</p>
			</div>
			...
			<div class="cp-support">
				...
				<p>Have any more customization beyond what Jupiter offers? Artbees experts are here to help. </p>
