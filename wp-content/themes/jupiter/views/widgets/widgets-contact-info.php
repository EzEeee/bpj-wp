...
?>
			...
			<?php if ( !empty( $email ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-envelope', 16); ?><span><a itemprop="email" href="mailto:<?php echo antispambot($email); ?>"><?php echo antispambot($email);?></a></span></li><?php endif;?>
			<?php if ( !empty( $website ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-icon-globe', 16); ?><span><a href="<?php echo $website; ?>" itemprop="url"><?php echo $website; ?></a></span></li><?php endif;?>
			<?php if ( !empty( $skype ) ):?><li><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true,'mk-moon-skype', 16); ?><span><a href="skype:<?php echo $skype; ?>?call"><?php echo $skype;?></a></span></li><?php endif;?>
			</ul>
		<?php
		echo $after_widget; 
